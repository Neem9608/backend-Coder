...
router.get('/', async (req, res) => {
  try {
    ...
    const products = await Product.find().select('title description price category availability').lean();
...
router.get('/paginated', async (req, res) => {
  ...
  try {
    ...
    if(req.query.sort === 'desc') {
     ...
     res.render('home', { products: filteredProducts, totalPages, currentPage: page });
  } else {
